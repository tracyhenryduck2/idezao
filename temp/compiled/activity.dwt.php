...
?>
        ...
        <div class="list-tuangou">
          <div class="list-tt">
            <div class="fl"><img data-original="<?php echo empty($this->_var['val']['logo']) ? 'images/ceshi.jpg' : $this->_var['val']['logo']; ?>" src="themes/68ecshopcom_360buy/images/loading-big.gif" height="260" width="580"></div>
